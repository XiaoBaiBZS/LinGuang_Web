...
$post_data_AppDownloadNum = isset($post_data['AppDownloadNum'])?$post_data['AppDownloadNum']:'';
$post_data_AppPackageName = isset($post_data['AppPackageName'])?$post_data['AppPackageName']:'';

if($post_data_AppPackageName == 0||$post_data_AppDownloadNum==0){
  $result["code"]=-1;
}
//包名是否重复
  ...
  if($app_data == false){
    ...
    $post_data_AppInerVersion = $app_data[0]['AppInerVersion'];
        ...
        ->update(
          [
            "AppDownloadNum"=>$post_data_AppDownloadNum
          ]
          );
