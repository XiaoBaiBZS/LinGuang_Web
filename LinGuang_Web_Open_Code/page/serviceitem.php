...
<html lang="zh-cn">
  ...
  <body style="text-align: left; padding: 20px;">
    ...
    <!-- <h1>隐私政策</h1> -->
    <div>更新日期：<strong>2024/3/15</strong></div>
    <div>生效日期：<strong>2024/3/15</strong></div>
    <h2>导言</h2>
    <p>
      <i>杭城迹忆</i> 是一款由 <i>白展硕</i> （以下简称“我们”）提供的产品。
      您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。
      本《隐私政策》与您所使用的 <i>杭城迹忆</i>
    ...
    <p>如对本《隐私政策》或相关事宜有任何问题，请通过 <strong>Zhanshuo.Bai@outlook.com</strong> 与我们联系。</p>
    ...
    <ul>
      ...
      <li>
        <strong>日志信息</strong>，指您使用我们的服务时，系统可能通过cookies、标识符及相关技术收集的信息，包括您的<strong>设备信息</strong>、<strong>浏览信息</strong>、<strong>点击信息</strong>，并将该等信息储存为日志信息，为您提供个性化的用户体验、保障服务安全。您可以通过浏览器设置拒绝或管理cookie、标识符或相关技术的使用。
      </li>
    </ul>
    ...
    <ul>
      <li>高德地图<dl>
          ...
          <dd>高德地图</dd>
          <dt>使用目的：</dt>
          <dd>用于页面中地图组件的展示，包括但不限于地图点标记、测距、路径规划、坐标系转换、数据可视化等。帮助用户更直观的看到不同标记点的位置。</dd>
          <dt>收集个人信息类型：</dt>
          <dd>用户手动设置的个人常用位置坐标</dd>
          <dt>处理方式：</dt>
          <dd>匿名化处理</dd>
          <dt>隐私政策链接：</dt>
          <dd>https://map.amap.com/doc/serviceitem.html</dd>
        </dl>
      </li>
      ...
      <li>腾讯兔小巢<dl>
          ...
          <dd>腾讯兔小巢</dd>
          <dt>使用目的：</dt>
          <dd>用于社区功能的搭建，使用户可以在社区交流。</dd>
          <dt>收集个人信息类型：</dt>
          <dd>用户账号（QQ号）、用户昵称</dd>
          <dt>处理方式：</dt>
          <dd>加密算法处理</dd>
          <dt>隐私政策链接：</dt>
          <dd>https://txc.qq.com/xy/agreement.html</dd>
        </dl>
      </li>
      <li>WPS金山文档<dl>
          <dt>第三方名称：</dt>
